...
gitrepo() {
    ...
    git remote add origin "ssh://git@codeberg.org/MattFor/${repo}.git"
    git remote add github "git@github.com:MattFor/${repo}.git"

    git remote set-url --add --push origin "ssh://git@codeberg.org/MattFor/${repo}.git"
    git remote set-url --add --push origin "git@github.com:MattFor/${repo}.git"
